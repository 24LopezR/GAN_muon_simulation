...
def multi_radius_plot(evaluation_dataset):
	real = evaluation_dataset[:,0:4]
	fake = evaluation_dataset[:,4:8]
	label_radius = evaluation_dataset[:,8]
	...
	axes = [ax1, ax2]
	ax1.hist(real[:,0][label_radius==20],  bins=200, density=False, range=(-25,25), histtype='step', color='blue',
			 label='data $\Delta_x$ (r=20)')
	ax1.hist(real[:, 0][label_radius == 4], bins=200, density=False, range=(-25, 25), histtype='step', color='green',
			 label='data $\Delta_x$ (r=4)')
	ax2.hist(fake[:, 0][label_radius == 20], bins=200, density=False, range=(-25, 25), histtype='step', color='blue',
			 label='fake $\Delta_x$ (r=20)')
	ax2.hist(fake[:, 0][label_radius == 4], bins=200, density=False, range=(-25, 25), histtype='step', color='green',
			 label='fake $\Delta_x$ (r=4)')
	for ax in axes:
		ax.set_yscale('log')
		ax.legend()
	plt.show()
	...
	axes = [ax3, ax4]
	ax3.hist(real[:, 2][label_radius == 20], bins=200, density=False, range=(-1.5, 1.5), histtype='step', color='blue',
			 label='data $\Delta_{v_x}$ (r=20)')
	ax3.hist(real[:, 2][label_radius == 4], bins=200, density=False, range=(-1.5, 1.5), histtype='step', color='green',
			 label='data $\Delta_{v_x}$ (r=4)')
	ax4.hist(fake[:, 2][label_radius == 20], bins=200, density=False, range=(-1.5, 1.5), histtype='step', color='blue',
			 label='fake $\Delta_{v_x}$ (r=20)')
	ax4.hist(fake[:, 2][label_radius == 4], bins=200, density=False, range=(-1.5, 1.5), histtype='step', color='green',
			 label='fake $\Delta_{v_x}$ (r=4)')
	for ax in axes:
		ax.set_yscale('log')
		ax.legend()
	plt.show()