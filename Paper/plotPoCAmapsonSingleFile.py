...
Toma como input el archivo .root creado con runPoCAonG4.py.
-------------------------------------------------------------------------------
'''

################################ CONSTANTS ####################################
POCA_FILE_PATH = '/home/ruben/Documents/DatosPipesPoCA/'
OUTPUT_FILE_PATH = "/home/ruben/Documents/DatosPipesPoCA/"
MAX_HIST = 1.
MIN_HIST = 1e-4
NBINSX = 50
NBINSY = 50
...
if __name__== "__main__":
    ...
    h_RMS.Write()
    h_RMS_a = r.TH2F(f"h2_RMS", f"Scattering angle RMS (approx.) YZ; Y; Z", NBINSX, -50, 50, NBINSY, -50, 50)
