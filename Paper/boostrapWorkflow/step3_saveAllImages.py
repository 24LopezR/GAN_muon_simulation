...
HIST_FILE_PATH = '/home/ruben/Documents/GAN_muon_simulation/Paper/boostrapWorkflow/2Dmaps/'
...
if __name__=='__main__':
    ...
    for f in os.listdir(HIST_FILE_PATH):
        ...
        h.Draw('COL AH');
        time.sleep(2)
        c.GetPad(0).SaveAs(f"/home/ruben/Documents/GAN_muon_simulation/Paper/boostrapWorkflow/images/h_{f.split('.')[0]}_RMS.png")
        del h
