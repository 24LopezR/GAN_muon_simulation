...
def plot_position_difference(scale):
    ...
    h1 = ax1.hist(Dx, bins=100, density = True, range = (-5,5), histtype = 'step', color = 'black', label='data $\Delta x$')
    h2 = ax2.hist(Dy, bins=100, density = True, range = (-5,5), histtype = 'step', color = 'black', label='data $\Delta y$')
    if options.fit:
    ...
    h1 = ax1.hist(Dxg, bins=100, density = True, range = (-5,5), histtype = 'step', color = 'red', label='generated $\Delta x$')
    h2 = ax2.hist(Dyg, bins=100, density = True, range = (-5,5), histtype = 'step', color = 'red', label='generated $\Delta y$')
